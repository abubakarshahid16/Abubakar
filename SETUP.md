...
> `test_claude_api` five, which were `xfail(strict=True)` (#222) and now PASS: the Claude lane
> was revived on 2026-09-25 (owner decision) and its router is registered. The table below is
...
- `test_claude_api` x5: the Claude router is deliberately not registered (B5) -
  **revived 2026-09-25 (#222): router registered, the five pass;**
