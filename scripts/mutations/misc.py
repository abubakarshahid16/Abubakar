...
MUTATIONS: tuple[Mutation, ...] = (
    ...
    Mutation(
        id="M767", phase=67,
        description="B6: lines are ignored, so a table's rows bridge into one 'sentence' and pass the gate",
        path=APP / "quality.py",
        anchor="    for line in text.splitlines():\n",
        replacement="    for line in [text]:\n",
        target="tests/test_b6_measure_in_clause.py",
        keyword="table_rows_are_not_read",
    ),
)
