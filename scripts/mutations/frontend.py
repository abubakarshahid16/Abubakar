...
MUTATIONS: tuple[Mutation, ...] = (
    ...
    # ---- owner decision 2026-09-26: 'Save as report', saved to CRS & Reports ----
    Mutation(
        id="M1014", phase=86, runner="vitest",
        description="the action is not called 'Save as report'",
        path=FRONTEND_SRC / 'components' / 'chat' / 'AnswerActions.tsx',
        anchor='            {savingReport ? "Saving…" : "Save as report"}\n',
        replacement='            {savingReport ? "Saving…" : "Save as PDF"}\n',
        target="src/views/ChatView.test.tsx",
        keyword='offers report generation',
        tags=("chat", "ui"),
    ),
    Mutation(
        id="M1015", phase=86, runner="vitest",
        description='a saved report is not reported as saved',
        path=FRONTEND_SRC / 'views' / 'ChatView.tsx',
        anchor='      setReportSaved((s) => ({ ...s, [messageId]: true }));\n',
        replacement='',
        target="src/views/ChatView.test.tsx",
        keyword='offers report generation',
        tags=("chat", "ui"),
    ...
    Mutation(
        id="M1016", phase=86, runner="vitest",
        description="'Open' does not take the reader to CRS & Reports",
        path=FRONTEND_SRC / 'views' / 'ChatView.tsx',
        anchor='            onOpenReports={onNavigate ? () => onNavigate("reports") : undefined}\n',
        replacement='',
        target="src/views/ChatView.test.tsx",
        keyword='offers report generation',
        tags=("chat", "ui"),
