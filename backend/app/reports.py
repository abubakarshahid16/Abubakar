...
CSS = """
body { font-family: sans-serif; font-size: 10pt; color: #17202a; line-height: 1.35; }
h1 { font-size: 23pt; color: #123b52; margin: 0 0 3pt; }
h2 { font-size: 12pt; color: #123b52; margin-top: 18pt; padding-bottom: 3pt;
     border-bottom: 1.5px solid #2a7188; }
p { overflow-wrap: anywhere; }
.masthead { border-bottom: 4px solid #2a7188; padding: 4pt 0 9pt; margin-bottom: 10pt; }
.kicker { color: #2a7188; font-size: 8pt; font-weight: bold; letter-spacing: 1.2pt;
          text-transform: uppercase; margin: 0 0 3pt; }
.meta { font-size: 8.5pt; color: #52616b; }
.box { border: 1px solid #b7cbd3; background: #f3f8fa; padding: 8pt 10pt; margin: 9pt 0; }
.approval { border: 1px solid #b45309; background: #fff7ed; padding: 6pt;
            margin: 8pt 0; font-size: 9.5pt; }
table { table-layout: fixed; width: 100%; border-collapse: collapse; font-size: 8.5pt; margin-top: 6pt; }
th, td { border: 1px solid #b7cbd3; padding: 4pt; text-align: left;
         overflow-wrap: anywhere; word-break: break-all; vertical-align: top; }
th { background: #e5f0f3; color: #123b52; }
.quote { font-family: serif; font-size: 10.5pt; border-left: 3px solid #333;
         padding: 6pt 9pt; margin: 6pt 0; background: #fafcfc; }
...
.audit, .approval, .box, .quote, .generated, .warn, table { break-inside: avoid; }
"""
...
def to_html(s: dict) -> str:
    ...
    parts = [
        '<div class="masthead"><p class="kicker">RAG Intelligence System</p>'
        '<h1>Evidence report</h1>'
        '<p class="meta">Single-answer, source-grounded record</p></div>',
